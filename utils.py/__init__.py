...
def templ_operation(oper_dict: dict):
    ...
    :return: отформатированные данные по операции - дата, описание, источник, назначение, сумма и валюта операциии
...
def add_mask(original_str: str):
    ...
    Если длина номера не 16 и не 20, номер маскирется целиком.
